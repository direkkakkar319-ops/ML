...
class Dual:
    ...
    def relu(self):
        if self.real_number > 0:
            return Dual(real_number=self.real_number, dual_number=self.dual_number)
        else:
            return Dual(real_number=0.0, dual_number=0.0)
...
if __name__ == "__main__":
    ...
    x_val = Dual(real_number=2.0, dual_number=1.0)
